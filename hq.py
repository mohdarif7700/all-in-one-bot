...
loop.create_task(bot.start("NTU3OTEyMTY4Njc1MTQ3Nzg3.XY39_Q.Qj0WJNblaSNvCqJxMh1tHH931qw"))
loop.create_task(selfbot.start("NDcxNzUzNjA2Nzk0NTc1ODky.XYYf5A.F3MhfgYLNctF7NkH8vMj2xYrmFo", bot=False))
